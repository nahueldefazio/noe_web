...
function Servicios() {
    return (
        <>
            <h2 className="margin_title white">Servicios</h2>
            <div className="d-flex m-5">
                <img alt="consultor digital" src={ consultor_digital } className="mx-5"/>
                <div>
            ...
            <div className="d-flex m-5">
                <img alt="asesoria" src={ asesoria } className="mx-5"/>
                <div>
            ...
            <div className="d-flex m-5">
                <img alt="auditoria-logo" src={ auditoria }  className="mx-5"/>
                <div>
            ...
            <div className="d-flex m-5">
                <img alt="gestion-rrss-logo" src={ gestion_rrss } className="mx-5" />
                <div>
            ...
            <div className="d-flex m-5">
                <img alt="podcast-logo" src={ podcast } className="mx-5"/>
               <div>
